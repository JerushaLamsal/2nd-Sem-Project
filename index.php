...
<body>
      ...
      <div class="row">
        <div class="col-md-9 ">
          <a class="px-3   text-decoration-none  " href="#"><i class="fa-solid fa-location-dot px-1 "></i>Ratnachowk
            POKHARA</a>
          <a href="#" class=" text-decoration-none "><i class="fa-solid fa-envelope  px-1 "></i>info@bcafe.com</a>
        </div>
        <div class="col-md-3 >
  ...
  <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <img src="./uploads/img/home" class="d-block w-100" alt="Sunset Over the City" />
  ...
  <!-- services  -->
  <section style="background-color: #EDF1F5;">
    <h1 class=" text-center"> service</h1>
    <div class="services">
      <div class="ser1 services-photos">
        <img src="./uploads/img/banq.jpg" width="318px" height="158px" alt="">
        <h1 class=" text-center">Banquet hall</h1>
      </div>
      <div class="ser2 services-photos">
        <img src="./uploads/img/ordwe.jpg" width="318px" height="158px" alt="">
        <h1 class=" text-center">Food Delevery</h1>
      </div>
      <div class="ser3 services-photos">
        <img src="./uploads/img/ice2.jpg" width="318px" height="158px" alt="">
        <h1 class=" text-center">Catering Service</h1>
      </div>
    </div>
  </section>
  ...
  <div class="container">
     <div class="row">
      <div class="mt-5 ms-3 mb-1">
        <button class="btn btn-warning"> Bakeries Items </button>

      </div>
      <div class="col-lg-6">
      <figure class="figure">
  <img src="./uploads/img/donut9" class="figure-img img-fluid rounded" alt="...">
  <h2 class=" ms-3 text-success">
    NRP <del>999</del> 850
  </h2>
  <figcaption class="figure-caption text-end">Set of 9 Delicious Donuts Pack</figcaption>
</figure>
      </div>
      <div class="col-lg-6">
      <figure class="figure">
  <img src="./uploads/img/donut3" class="figure-img img-fluid rounded" alt="...">
  <h2 class=" ms-3 text-success">
    NRP <del>1000</del> 890
  </h2>
  <figcaption class="figure-caption text-end">8 pcs Delicious Donuts with Sprinkle</figcaption>
</figure>
      </div>
      </div>
  </div>
  ...
  <div class="container">
     <div class="row">
      <div class="mt-5 ms-3 mb-1">
        <button class="btn btn-warning"> Choco Bar </button>

      </div>
      <div class="col-lg-6">
      <figure class="figure">
  <img src="./uploads/img/cb" class="figure-img img-fluid rounded" alt="...">
  <h2 class=" ms-3 text-success">
    NRP  550
  </h2>
</figure>
  ...
  <div class="container-fluid">
     <div class="row">
      ...
      <figure class="figure">
  <img src="./uploads/img/ck1" class="figure-img img-fluid rounded" alt="...">
  <h2 class=" ms-3 text-success">
    NRP  550
  </h2>
</figure>
      ...
      <figure class="figure">
  <img src="./uploads/img/ck2" class="figure-img img-fluid rounded" alt="...">
  <h2 class=" ms-3 text-success">
    NRP 600
  </h2>
</figure>
      ...
      <figure class="figure">
  <img src="./uploads/img/ck3" class="figure-img img-fluid rounded" alt="...">
  <h2 class=" ms-3 text-success">
    NRP 600
  </h2>
</figure>
